...
const { botanicalName, commonName, stockCount, seasonality, description, price } = req.body;
    try {
        console.log(req.body)
        const plant = await Plant.create({ botanicalName, commonName, stockCount, seasonality, description, price });
